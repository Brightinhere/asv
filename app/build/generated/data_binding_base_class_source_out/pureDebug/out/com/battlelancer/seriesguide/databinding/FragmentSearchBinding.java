...
public final class FragmentSearchBinding implements ViewBinding {
  ...
  private FragmentSearchBinding(@NonNull FrameLayout rootView, @NonNull GridView gridViewSearch,
      @NonNull FrameLayout searchFragment, @NonNull TextView textViewSearchEmpty) {
  ...
  public static FragmentSearchBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      TextView textViewSearchEmpty = ViewBindings.findChildViewById(rootView, id);
      if (textViewSearchEmpty == null) {
        break missingId;
      }

      return new FragmentSearchBinding((FrameLayout) rootView, gridViewSearch, searchFragment,
          textViewSearchEmpty);
    }
