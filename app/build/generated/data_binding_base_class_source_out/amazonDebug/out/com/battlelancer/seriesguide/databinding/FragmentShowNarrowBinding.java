...
public final class FragmentShowNarrowBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final RatingsShowsNarrowBinding containerRatings;
  ...
  private FragmentShowNarrowBinding(@NonNull ScrollView rootView,
      ...
      @NonNull RatingsShowsNarrowBinding containerRatings,
      @NonNull MaterialCardView containerShowPoster, @NonNull ImageView imageViewShowPoster,
      @NonNull View imageViewShowPosterBackground, @NonNull ScrollView scrollViewShow,
      @NonNull TextView textViewShowReleaseTime, @NonNull TextView textViewShowStatus) {
  ...
  @NonNull
  public static FragmentShowNarrowBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentShowNarrowBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_show_narrow, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentShowNarrowBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      RatingsShowsNarrowBinding binding_containerRatings = RatingsShowsNarrowBinding.bind(containerRatings);
      ...
      return new FragmentShowNarrowBinding((ScrollView) rootView, barrierPosterButtonsBottom,
