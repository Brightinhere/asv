...
public final class ActivityMovieBinding implements ViewBinding {
  ...
  private ActivityMovieBinding(@NonNull FrameLayout rootView, @NonNull FrameLayout contentFrame) {
  ...
  public static ActivityMovieBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMovieBinding((FrameLayout) rootView, contentFrame);
    }
