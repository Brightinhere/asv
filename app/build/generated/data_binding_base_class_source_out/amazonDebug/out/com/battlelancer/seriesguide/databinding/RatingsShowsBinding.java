...
public final class RatingsShowsBinding implements ViewBinding {
  @NonNull
  ...
  private RatingsShowsBinding(@NonNull ConstraintLayout rootView, @NonNull Barrier barrier,
  ...
  @NonNull
  public static RatingsShowsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static RatingsShowsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.ratings_shows, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static RatingsShowsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RatingsShowsBinding((ConstraintLayout) rootView, barrier, imageViewRatingsIcon,
