...
import com.battlelancer.seriesguide.sync.TmdbSyncTest_MembersInjector;
...
public final class DaggerTestServicesComponent implements TestServicesComponent {
  private final AppModule appModule;

  private final DaggerTestServicesComponent testServicesComponent = this;
  ...
  private DaggerTestServicesComponent(AppModule appModuleParam,
      HttpClientModule httpClientModuleParam, TmdbModule tmdbModuleParam,
      TraktModule traktModuleParam) {
  ...
  @Override
  public void inject(AddShowTask arg0) {
  }

  @Override
  public void inject(SgSyncAdapter arg0) {
    injectSgSyncAdapter(arg0);
  }

  @Override
  public void inject(TraktAddLoader arg0) {
  }

  @Override
  public void inject(TraktCommentsLoader arg0) {
    injectTraktCommentsLoader(arg0);
  }

  @Override
  public void inject(TmdbSyncTest tmdbSyncTest) {
    injectTmdbSyncTest(tmdbSyncTest);
  }
  ...
  @CanIgnoreReturnValue
  private TmdbSyncTest injectTmdbSyncTest(TmdbSyncTest instance) {
    TmdbSyncTest_MembersInjector.injectTmdbConfigService(instance, provideConfigurationServiceProvider.get());
    TmdbSyncTest_MembersInjector.injectMovieTools(instance, movieTools());
    return instance;
  }
  ...
  public static final class Builder {
    ...
    public TestServicesComponent build() {
      ...
      return new DaggerTestServicesComponent(appModule, httpClientModule, tmdbModule, traktModule);
    }
  }
}
